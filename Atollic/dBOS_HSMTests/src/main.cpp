 ...
 * @date 27/05/2015
 *
 * \brief Implementation of dBOS State Machine Test Application.
 *
 */
...
static const fptrTest pTests[] = { TestHSM_Test1, TestHSM_Test2, TestHSM_Test3, TestHSM_Test4, TestHSM_Test5, TestHSM_Test6 };
